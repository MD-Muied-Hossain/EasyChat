...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void getImageInImageView() {
        //google it = How to transform a uri to a bitmap
        Bitmap bitmap = null;
        try {
    ...
    private void uploadImageToFirebase() {
        ...
        //random name for each photo to avoid overriding names issue
    ...
    private void updateProfilePicture(String url) {
        FirebaseDatabase.getInstance()
                .getReference("user/"+ FirebaseAuth.getInstance().getCurrentUser().getUid() +"/profilePictureUrl")
                .setValue(url);
    }
}
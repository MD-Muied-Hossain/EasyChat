...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UserHolder> {
    ...
    public UserHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.user_item_holder,parent,false);
    ...
    public void onBindViewHolder(@NonNull UserHolder holder, int position) {
        ...
        Glide.with(context).load(users.get(position).getProfilePictureUrl())
                .error(R.drawable.account_img).placeholder(R.drawable.account_img).into(holder.imageView);
    }
